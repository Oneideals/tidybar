...
let suites: [TestSuite] = [
    ...
    TestSuite("ReviewRegression", ReviewRegressionTests.testCases),
    TestSuite("MenuBarArrangement", MenuBarArrangementTests.testCases),
    TestSuite("MenuBarHitTesting", HitTestingTests.testCases),
    ...
    TestSuite("MenuBarClickRelay", ClickRelayTests.testCases),
