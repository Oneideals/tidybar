...
> **Last Updated:** 2026-09-15T17:29:16Z (read-only projection)
> **Git State:** `clean` | **Branch:** `main` | **Events Count:** 197
...
- **agy** (`b30ba57a-24f8-428e-ba01-52c5b75c95de`): 修复MenuBarAccessSession在已有regular策略或多桌面时返回nil导致整理报错 *(files: sources/tidybarcore/app/menubaraccesssession.swift, sources/tidybarcore/app/settingswindow.swift)*
