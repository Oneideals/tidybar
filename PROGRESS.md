...
> **Last Updated:** 2026-09-15T10:50:57Z (read-only projection)
> **Git State:** `dirty` | **Branch:** `main` | **Events Count:** 188
...
- **agy** (`b30ba57a-24f8-428e-ba01-52c5b75c95de`): 修复CaptureSweep截图校验幕布遮挡、PeekCoordinator拖拽遮挡与分区判定盲区 *(files: sources/tidybarcore/app/peekcoordinator.swift, sources/tidybarcore/app/tidybarapplication.swift, sources/tidybarcore/panel/tidybarpanel.swift)*

## 📝 Working Tree Changes

- `.M` `Sources/TidyBarCore/App/PeekCoordinator.swift`
