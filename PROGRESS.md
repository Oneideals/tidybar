...
> **Last Updated:** 2026-09-10T14:56:02Z (read-only projection)
> **Git State:** `clean` | **Branch:** `main` | **Events Count:** 125
...
- **agy** (`44ceb2e3-2fd7-4a0e-b14d-c7796f1f9c52`): 重塑TidyBar设置面板：现代macOS侧边栏导航与卡片式信息架构 *(files: sources/tidybarcore/app/settingswindow.swift)*
