...
> **Last Updated:** 2026-09-15T17:04:25Z (read-only projection)
> **Git State:** `clean` | **Branch:** `main` | **Events Count:** 194
...
- **agy** (`b30ba57a-24f8-428e-ba01-52c5b75c95de`): 保持整理期间设置面板不被隐藏或退到后台 *(files: sources/tidybarcore/app/settingswindow.swift, sources/tidybarcore/app/tidybarapplication.swift)*
