...
> **Last Updated:** 2026-09-14T08:51:27Z (read-only projection)
> **Git State:** `clean` | **Branch:** `main` | **Events Count:** 154
...
- **agy** (`1d02cfa9-e97b-44fc-a30c-00a78297ecb4`): 修复折叠功能：撤回 isVisible 策略，改用纯 length 控制 *(files: sources/tidybarcore/app/tidybarapplication.swift)*
