...
> **Last Updated:** 2026-09-14T15:41:29Z (read-only projection)
> **Git State:** `dirty` | **Branch:** `main` | **Events Count:** 172
...
- **agy** (`b30ba57a`): 修复图标风格不一致和抽屉点击全部显示的两个bug *(files: sources/tidybarcore/app/iconoverviewview.swift, sources/tidybarcore/app/settingswindow.swift, sources/tidybarcore/app/tidybarapplication.swift, sources/tidybarcore/panel/tidybarpanel.swift, sources/tidybarcore/panel/tidybarsearchpanel.swift)*
