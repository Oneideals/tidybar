...
> **Last Updated:** 2026-09-14T08:40:51Z (read-only projection)
> **Git State:** `clean` | **Branch:** `main` | **Events Count:** 151
...
- **agy** (`1d02cfa9-e97b-44fc-a30c-00a78297ecb4`): 修复点击折叠按钮无法生效的问题 *(files: sources/tidybarcore/app/tidybarapplication.swift)*
